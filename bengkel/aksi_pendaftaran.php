...
elseif ($act=='input'){
	...
	$sql = "INSERT INTO pendaftaran VALUES ('','$hari_ini','$no_pol','$nama_pelanggan','$keluhan','$status')";
...
elseif ($act=='update'){
	...
	$sql = "UPDATE pendaftaran SET no_pol='$no_pol', nama_pelanggan='$nama_pelanggan', keluhan='$keluhan',
